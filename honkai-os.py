...
from settings_honkai import log, CONFIG_honkai
from sign_honkai import Sign_honkai
from notify_honkai import Notify_honkai
...
if __name__ == '__main__':
    ...
    for i in range(len(cookie_list)):
        ...
        try:
            ...
            msg += Sign_honkai(cookie_list[i]).run()
            msg_list += msg
    ...
    notify.send(status=f'\n{success_num}/{total_num} succeded', msg=msg_list)
    if ret != 0:
